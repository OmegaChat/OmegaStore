...
app.prepare().then(() => {
	createServer((req, res) => {
		...
		console.log("┃    \x1b[2m%s %s\x1b[36m%s\x1b[37m\x1b[1m\x1b[0m                              ┃", "by", "Omega", "Chat")
		console.log("┃                                              ┃")
		console.log("┃    \x1b[36m>\x1b[37m Server running on port \x1b[36m%s\x1b[37m             %s┃", (dev ? 3000 : 80), (dev ? "" : "  "))
		console.log("┃                                              ┃")
		console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛")
		console.log("												 ")
		console.log("												 ")
